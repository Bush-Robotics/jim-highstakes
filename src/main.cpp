...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      ...
      {"Blue Negative (No Alliance)\n\nBlue negative routine w/out alliance stake", blue_negative_noalliance},
      {"Blue Positive (No Alliance)\n\nBlye positive routine w/out alliance stake", blue_positive_noalliance},
      {"Red Negative (No Alliance)\n\nRed negative routine w/out alliance stake", red_negative_noalliance},
      {"Red positive(No Alliance)\n\nRed positive routine w/out alliance stake", red_positive_noalliance},
